...
function FormatAttachmentInfo(data) {
    $.post(
        "https://qr-inventory/GetWeaponData",
        JSON.stringify({
            weapon: data.name,
...
function handleAttachmentDrag() {
    ...
    $(".weapon-attachments-remove").droppable({
        ...
        drop: function(event, ui) {
            $.post(
                "https://qr-inventory/RemoveAttachment",
                JSON.stringify({
...
$(document).on("click", ".CombineItem", function(e) {
    ...
    if (combineslotData.toData.combinable.anim != null) {
        $.post(
            "https://qr-inventory/combineWithAnim",
            JSON.stringify({
        ...
        $.post(
            "https://qr-inventory/combineItem",
            JSON.stringify({
...
function optionSwitch(
    ...
    $.post(
        "https://qr-inventory/SetInventoryData",
        JSON.stringify({
...
function swap($fromSlot, $toSlot, $fromInv, $toInv, $toAmount) {
    ...
    if (fromData !== undefined && fromData.amount >= $toAmount) {
        ...
        if (
            ...
            $.post("https://qr-inventory/PlayDropSound", JSON.stringify({}));
            $.post(
                "https://qr-inventory/SetInventoryData",
                JSON.stringify({
                    fromInventory: $fromInv.attr("data-inventory"),
            ...
            if (fromData.amount == $toAmount) {
                if (
                    ...
                    $.post(
                        "https://qr-inventory/getCombineItem",
...
function InventoryError($elinv, $elslot) {
    ...
    $.post("https://qr-inventory/PlayDropFail", JSON.stringify({}));
}
